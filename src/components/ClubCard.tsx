            ...
            <div className="bg-slate-600/40 hover:bg-zinc-900 w-80     lg:w-96 p-2    text-white rounded-t-lg my-1 lg:my-3 transition" onClick={() => router.push(`/club/${id}`)}>
                ...
                <div className="flex">
                    ...
                    <div className="p-1 md:p-2 overflow-hidden">
                        <p className=" text-red-600 text-xs text-wrap md:text-sm font-bold cursor-pointer">
                            {roomName}
                        </p>
                        <p className=" text-white text-xs  md:text-base truncate cursor-pointer font-bold">
