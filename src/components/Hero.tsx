    ...
    return (
        <div className="">
            <MaxWidthWrapper className="mb-12 mt-28 md:mt-40 flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-5 max-w-prose text-slate-300 sm:text-lg">Welcome to our world of cinematic exploration, where every movie enthusiast embarks on a journey of discovery. We believe that every film holds a unique story, waiting to captivate and inspire. With our personalized recommendation system, powered by your favorite movies, we're here to guide you to your next unforgettable cinematic experience</p>
