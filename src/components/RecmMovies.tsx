...
function RecmMovies() {
    const { loadingRes, result, movie, imdbId } = useContext(MovieContext)
    ...
    return (
        <div className=' p-3 mt-3  bg-gradient-to-r from-black  to-slate-900 shadow-xl rounded-md py-5 shadow-slate-700'>
            {
                loadingRes ? (
